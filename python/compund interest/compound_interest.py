...
def calculate_ci():
    principle=int(principal_field.get())
...
if __name__=="__main__":
    ...
    root.title("compund intreat calculator")
    label=Label(root,text="Principle Amount (Rs):",fg='black',bg='red')
    label2=Label(root,text="Rate (%):",fg='black',bg='red')
    label3=Label(root,text="Time (Years) :",fg='black',bg='red')
    label4=Label(root,text="Compund Interest :",fg='black',bg='red')
